...
<link rel="shortcut icon" href="http://i.imgur.com/cgE7tbQ.png" />
...
<div class="container">
    <div class="row colored">
        <div class="contcustom">
            <img src="http://i.imgur.com/ScVZqOT.png" alt="Smiley face" width="70" height="70">
            <h2></h2>
            <div><form action="./login.php" method="post">
                <input name="user" type="text" placeholder="@username" required="required"><br/>
